...
namespace RealtyAgency
{
    public partial class Admin : Form
    {
        ...
        private void RegisterButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (SurnameInput.Text != "" && NameInput.Text != "" && LastNameInput.Text != "" && DealshareInput.Text != ""
                     && LoginInput.Text != "" && PasswordInput.Text != "" && PassConfirmInput.Text != "")
                {
                    if (LoginInput.Text.Length > 5 && PasswordInput.Text.Length > 5)
                    {
                        if (PasswordInput.Text == PassConfirmInput.Text)
                        {
                            ...
                            string CreateNewClient = "execute CreateNewRieltor " + "\'" + SurnameInput.Text + "\'" + "," + "\'" + NameInput.Text + "\'" +
                                "," + "\'" + LastNameInput.Text + "\'" + "," + "\'" + DealshareInput.Text + "\'" +
                                "," + "\'" + UserID + "\'";
                            ...
                            string GetRieltorsList = "select * from GetRieltorsList";
                            RieltorsData.DataSource = DB.SearchValuesQuery(GetRieltorsList);
                        }
                        else
                        {
        ...
        {
            string GetClientsWishes = "select * from GetAllClientsWishes";
            ClientsWishesData.DataSource = DB.SearchValuesQuery(GetClientsWishes);
        ...
        private void DealshareInput_TextChanged(object sender, EventArgs e)
        {
